...
module.exports = {
  ...
  updates: {
    windows: updateConfig('windows', '0.1.306', 'ava-windows-0.1.306.zip', 'AVA Windows update'),
    android: updateConfig('android', '0.1.306', 'ava-android-0.1.306.apk', 'AVA Android update'),
